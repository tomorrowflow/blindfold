"""Single-file management SPAs for the org graph and entity list (ADR-0011).
...
unified shell at ``/ui/inbox`` (issue #99); the JSON endpoints it consumed
(``/v1/management/review-inbox`` + ``…/{id}/confirm`` + ``…/{id}/reject``)
are unchanged and now serve the shell's React view instead.
