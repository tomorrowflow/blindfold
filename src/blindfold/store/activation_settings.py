"""Live store for the L3 GLiNER cascade's persisted activation Setting
...
(config.py's persisted-overlay-on-env read, ADR-0034 §1). Same synchronous
...
issue #200) exactly like :class:`~blindfold.store.entity_graph_store.PostgresEntityGraphStore`.
