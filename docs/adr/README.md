...
| [0050](0050-leak-gate-scope-symmetry-word-boundary-plus-mint-time-coverage.md) | Leak-gate scope symmetry — word-boundary matching + mint-time coverage refusal | Accepted |
